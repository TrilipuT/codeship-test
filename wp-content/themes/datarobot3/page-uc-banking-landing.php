...
<section class="uc-landing banking">
    ...
    <div class="top-wrapper" style="background-image: url()">
        <div class="top-banner">
          <div class="container clearfix">
              ...
              <div class="b-bottom">
                  <a href="#" class="contact-popup bg-filled-blue button"><?php _e('Request a demo', 'datarobot3'); ?></a>
                  <a href="<?php the_field('ebook_link'); ?>"><i class="icon-download"></i>Download eBook</a>
              </div>
          </div>
        </div>
    </div>
              ...
              <div class="container">
                  <div class="sections-switcher">
                      <?php foreach($rows as $key => $row){
                        if ($key == 0) { ?>
                          <div class="section active" sect="<?php echo $row['section_label']; ?>"><?php echo $row['section_label']; ?></div>
                        <?php } else { ?>
                          <div class="section" sect="<?php echo $row['section_label']; ?>"><?php echo $row['section_label']; ?></div>
                        <?php }
                      } ?>
                  </div>
    ...
    <div class="events-announcement">
        ...
        <div class="get-in-touch">
            <div class="container">
                <div class="button-wrap">
                    <p><?php _e('Want to use DataRobot for your project?', 'datarobot3'); ?></p>
