			...
			<div class="banner-content">
				...
				<div class="banner-buttons" data-hj-ignore-attributes>
					<?php
						...
						foreach($rows as $row){
							$image = $row['icon'];
							$demo = ($row['type'] == "Request a demo" or $row['type'] == "デモのリクエスト") ? true : false; ?>
							<div class="item transition01 <?php if ($demo) { echo 'demo'; } ?>">
								<a href="#<?php str_source($row['title']); ?>" class="contact-popup" data-source="<?php echo $row['title']; ?>" data-type="<?php echo $row['type']; ?>">
									<div class="image-wrap">
										<img src="<?php echo $image['url']; ?>" width="<?php echo ($image['width']/2); ?>" alt="<?php echo $row['title']; ?>">
									</div>
									<h2 class="transition01"><?php echo $row['title']; ?></h2>
									<p><?php echo $row['text']; ?></p>
									<?php if ($demo) {
										echo '<span class="bg-filled-orange button">'. $row['button_text'] .'</span>';
									} else {
										echo '<span class="bg-filled-white button">'. $row['button_text'] .'</span>';
									}?>
								</a>
							</div>
					<?php } ?>
		...
		<div class="departments">
			<div class="container">
				<div class="headquarters">
                    ...
                    <a href="#Boston" class="contact-popup" data-source="Boston Office" data-country="United States" data-state="Massachusetts">
						...
						<div class="item">
							...
							<ul class="offices">
								<?php foreach ($row['offices'] as $office) { ?>
									<li>
										<a href="#<?php str_source(str_location($office['office_location'])); ?>" class="contact-popup" data-country="<?php echo $office['country']; ?>" data-state="<?php echo $office['state']; ?>" data-source="<?php str_location($office['office_location']); ?> Office"><?php str_location($office['office_location']); ?></a><span><?php str_state($office['office_location']); ?></span>
									</li>
								<?php } ?>
							</ul>
						</div>
