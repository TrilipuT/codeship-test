<?php
/* Template Name: Automated Machine Learning */
?>
<?php get_header('guide'); ?>
<section class="guide aml">
	<div class="top-block">
		<div class="container">
			<div class="wrap">
				<h1 style="font-size: 34px;">A Practical Guide to Automated Machine Learning.</h1>
				<p style="font-size: 18px;">Applying automation to data science is a transformative process, and like any form of digital transformation, should be undertaken in stages.</p>
			</div>
		</div>
	</div>
			...
			<article class="guide-info">
				...
				<div class="b-form">
					<div class="dr-form form-blue">
						...
						<form method="post" name="AML-email" action="https://s2142644770.t.eloqua.com/e/f2" id="elqForm">
	            ...
	            <select name="stateProv" id="state" class="select" disabled>
	            	<option value="">State</option>
							...
							<input type="hidden" name="formName" value="AML-email">
	            <input type="hidden" name="elqFormName" value="AML-email">
                ...
                <span class="dr-loader">
                  <span class="loader">
                    ...
                    <span class="loader-inner"></span>
							...
							<input type="submit" value="Download now" class="submit bg-filled-blue button">
						</form>
				        ...
				        <script type='text/javascript'>
				            ...
				            if (typeof this.GetElqCustomerGUID === 'function') {
				                    document.forms["AML-email"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
				            return;
				            }
				            timeout -= 1;
				            }
                        ...
                        <script type='text/javascript'>
                            ...
                            jQuery(document).ready(function () {
                                ...
                                jQuery('.dr-form').submit(function (event) {
                                    ...
                                    jQuery('.dr-form .preloader').fadeIn(300);
                                ...
                                var validator = new FormValidator('AML-email', [{
                                    name: 'firstName',
