    ...
    <div class="top-wrapper" style="background-image: url()">
        <div class="top-banner">
            <div class="container clearfix">
                ...
                <div class="b-bottom">
                    <a href="#" class="contact-popup bg-filled-blue button">Watch a demo</a>
                ...
                <div class="recent-uc-posts">
                    ...
                    <div class="partners">
                        ...
                        <div class="logo-switcher">
                            <div class="switch active" area="sis">SI’s</div>
                            <div class="switch" area="platform">Platform</div>
                            <div class="switch" area="isvs">ISV’s</div>
                        </div>
                        </div>
                        <?php
        ...
        <div class="dr-form contact-form">
            ...
            <script type='text/javascript'>
                ...
                jQuery(document).ready(function ($) {
                    ...
                    jQuery(document).ready(function () {
                        jQuery('.logo[data-name="' + jQuery('.active').attr('area') + '"] > div').removeClass('logo-mask');
                        jQuery(document).on('click', '.switch', function () {
                            ...
                            jQuery('.logo[data-name="' + jQuery(this).attr('area') + '"] > div').removeClass('logo-mask');
                        });
                    });
                });
            </script>
