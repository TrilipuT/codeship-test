	...
	<div class="form-wrap">
		...
		<div class="dr-form contact-form">
			...
			<form method="post" name="Datarobot-main" action="https://s2142644770.t.eloqua.com/e/f2" target="hiddenframe" id="elqForm">
				<div class="form-section">
					<div class="form-main">
						...
						<input type="text" name="emailAddress" id="emailAddress" value="" class="text fullrow" maxlength="40" placeholder="Business email">
						<input type="text" name="busPhone" id="busPhone" value="" class="text fullrow" maxlength="40" placeholder="Phone">
				...
				<div class="form-footer clearfix">
		            <div class="form-extra-button transition">
		            	<i class="icon-message-reply"></i><span>Write a comment</span>
		            </div>
	        ...
	        <script type='text/javascript'>
                jQuery(function ($) {
                    function backToForm() {
                        var button = jQuery('.form-extra-button');
                        if (button.hasClass('back')) {
                            jQuery('.form-extra-wrap').hide();
                            jQuery('.form-main').fadeIn(300);
                            button.removeClass('back');
                            button.find('i').attr("class", "icon-message-reply");
                            button.find('span').text("Write a comment");
                        } else {
                            jQuery('.form-main').hide();
                            jQuery('.form-extra-wrap').fadeIn(300);
                            button.addClass('back');
                            button.find('i').attr("class", "icon-circle-left");
                            button.find('span').text("Back to contact info");
                        }
                    }
                    ...
                    $('.form-extra-button').click(backToForm);
