...
<head>
	...
	<!-- <link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_uri(); ?>?ver=<?php echo filemtime( get_stylesheet_directory() . '/style.css' ); ?>"> -->
  <link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri() . '/assets/built/stylesheets/zg-lp.css'; ?>">
	...
	<div class="wrapper">
        ...
        <?php if(get_field('navigation')){ ?>
          <div class="menu-extra mobile">
  					<a href="/careers/" class="menu-extra-link careers"><?php _e('We\'re hiring!', 'datarobot3'); ?></a>
  					<a href="/contact-us/" class="bg-filled-orange button menu-extra-button contact-sales"><?php _e('Contact Us', 'datarobot3'); ?></a>
  				</div>
...
<section class="zg persona" id="<?php echo strToLowRep(get_the_title()); ?>">
	<div class="top-banner">
		<div class="container clearfix">
          ...
          <?php } ?>
				...
				<div class="b-right">
          <div class="dr-form contact-form form-orange">
              ...
              <label class="last">
                <select name="title" id="title" class="select" placeholder="Role">
		              ...
		              <option value="Other">Other</option>
							...
							<textarea name="customersInterest" id="customersInterest" class="fullrow" rows="6" placeholder="Tell us about your interest"></textarea>
				...
				<div class="container">
					<ul class="items<?php echo $count; ?> clearfix">
						<?php foreach($features as $item){ ?>
							<li>
								<a href="#<?php strToLowRep($item['anchor_title']); ?>" class="transition"><?php echo $item['anchor_title']; ?></a>
							</li>
						<?php } ?>
					</ul>
				</div>
			...
			function WaitUntilCustomerGUIDIsRetrieved() {
				if (!!(timerId)) {
					...
					if (typeof this.GetElqCustomerGUID === 'function') {
						Array.prototype.forEach.call(document.forms, function(el, i){
							el.elements["elqCustomerGUID"].value = GetElqCustomerGUID();
						});
								//document.forms.elements["elqCustomerGUID"].value = GetElqCustomerGUID();
						return;
					}
					timeout -= 1;
				}
	...
	<script type='text/javascript'>
        jQuery(document).ready(function ($) {
            $('.contact-popup').click(function (e) {
                e.preventDefault();
                var formOffset = $('.dr-form').offset().top;
                var margin = 30;
                if ($(window).width() >= 1024) {
                    margin = 106;
                }
                $('body,html').animate({scrollTop: formOffset - margin}, 300);
            });
