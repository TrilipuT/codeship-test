                    	    ...
                    	    <svg width="36px" height="36px" viewBox="0 0 335 380">
                    	      <defs><path id="path-1"
                                        ...
                                        id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g
                                            id="datarobot-robot-monochrome"><g id="Clip-2"></g><path
                                                ...
                                                id="Fill-1" fill="#BECDD9" mask="url(#mask-2)"></path></g></g>
                    	    </svg>
...
<script>
    ...
    /*jQuery(document).ready(function () {
        ...
        var bigImgUrl = imageUrl.attr("data-img-big");
        var midImgUrl = imageUrl.attr("data-img-medium");
        if (viewportWidth > 1023) {
            jQuery(".top-wrapper").css('background-image', bigImgUrl);
        } else {
            if (midImgUrl !== 'url()') {
                jQuery(".top-wrapper").css('background-image', midImgUrl);
            } else {
                jQuery(".top-wrapper").css('background-image', bigImgUrl);
            }
        }
