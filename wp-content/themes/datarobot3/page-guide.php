			...
			<article class="guide-info">
				...
				<div class="b-form">
					<div class="dr-form form-blue">
						...
						<form method="post" name="KDnuggets-email" action="https://s2142644770.t.eloqua.com/e/f2" id="elqForm">
	            ...
	            <input type="hidden" name="submittedOnUrl" id="submittedOnUrl" value="">
							<input type="hidden" name="formName" value="KDnuggets-email">
	            <input type="hidden" name="elqFormName" value="KDnuggets-email">
                        ...
                        <script type='text/javascript'>
                            ...
                            jQuery(document).ready(function () {
                                ...
                                jQuery('.dr-form').submit(function (event) {
                                    ...
                                    identifyForm({industry: "industry"});
                                ...
                                var validator = new FormValidator('KDnuggets-email', [{
                                    name: 'firstName',
