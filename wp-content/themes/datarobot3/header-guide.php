...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri() . '/assets/built/stylesheets/lp.css'; ?>?ver=<?php echo filemtime( get_stylesheet_directory() . '/assets/built/stylesheets/lp.css' ); ?>">
			...
			<div class="container">
				<div id="logo">
					<a href="/" title="DataRobot Homepage">
						<?php if (get_field('page_styling_id') == 'sh_wr') { ?>
				...
				<div class="bpf">
					<?php
					if (get_field('page_styling_id') == 'sh_wr') {
						echo 'Become a Data Science Superhero';
					} else {
						echo 'Better predictions. Faster.';
					} ?>
				</div>
			</div>
		</header>
