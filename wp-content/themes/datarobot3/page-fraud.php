...
<section class="fd-lp">
	<div class="top-block">
		<div class="container">
			<div class="wrap">
				<h1>Want to better detect Fraud?</h1>
				<p>DataRobot is the prediction engine software behind the most successful FinTech and Financial Services companies to predict loan default, credit worthiness, online identity verification etc.</p>
			</div>
		</div>
	</div>
	<div class="main">
		<div class="guide-info">
			<div class="container">
				...
				<img src="<?= get_template_directory_uri(); ?>/assets/built/images/lp-img1.png" alt="Why DataRobot?">
				<p>Why DataRobot?</p>
				<ul>
					<li>
						<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/result-tick.png" alt='list'></span>
						Reduce Fraud Cost
					</li>
					<li>
						<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/result-tick.png" alt='list'></span>
					...
					<li>
						<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/result-tick.png" alt='list'></span>
						Increase productivity of Data Scientists  and Business Analysts
					</li>
				</ul>
				</div>
				<div class="b-form">
				<img src="<?= get_template_directory_uri(); ?>/assets/built/images/bring_the_data.png" alt="You bring the data, we build the models">
				<div class="dr-form form-blue">
					...
					<form method="post" name="Datarobot-main" action="https://s2142644770.t.eloqua.com/e/f2" id="elqForm">
		        ...
		        <select name="stateProv" id="state" class="select" disabled>
		        	<option value="">State</option>
						...
						<select name="stateProv" id="province" class="select" disabled>
						...
						<input type="submit" value="Download now" class="submit bg-filled-white button">
					</form>
				    ...
				    <script type='text/javascript'>
				        ...
				        if (typeof this.GetElqCustomerGUID === 'function') {
				                document.forms["KDnuggets-email"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
				        return;
				        }
				        timeout -= 1;
				        }
				    ...
				    <script type='text/javascript'>
                        ...
                        jQuery(document).ready(function () {
                            ...
                            var validator = new FormValidator('xxx', [{
                                name: 'firstName',
		...
		<div class="lp-clients">
			<div class="container">
				<h2>Our clients</h2>
				<ul>
					<li><img src="<?= get_template_directory_uri(); ?>/assets/built/images/lendingtree.png" alt="Lendingtree" style="width:217px;"></li>
					<li><img src="<?= get_template_directory_uri(); ?>/assets/built/images/bank_of_internet.png" alt="Bank of Internet USA" style="width:208px;"></li>
					<li><img src="<?= get_template_directory_uri(); ?>/assets/built/images/socure.png" alt="Socure" style="width:202px;"></li>
					<li><img src="<?= get_template_directory_uri(); ?>/assets/built/images/forward-financing.png" alt="Forward Financing" style="width:145px;"></li>
				</ul>
			</div>
		</div>

		<div class="lp-features-v">
			<div class="container">
				<article class="feature right-image clearfix">
					<div class="b-left">
						<h2>Build Models that Evolve as Fast as Fraud Does</h2>
						<p>As consumers buy more and more goods and services online, fraudulent credit card purchases, account takeover campaigns, and identity theft are all on the rise. To keep up with the fraudsters, data science teams at banks and credit card companies have to move faster than ever, but that isn’t easy considering:</p>
						<ul>
							<li>
								<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/ex-mark.png" alt='list'></span>
								Data scientists are in short supply
							</li>
							<li>
								<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/ex-mark.png" alt='list'></span>
								Fraud models can take weeks or months to build, test, and code
							</li>
							<li>
								<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/ex-mark.png" alt='list'></span>
								Traditional analytics software can be costly and adoption can be time-consuming
							</li>
						</ul>
					</div>
					<div class="b-right">
						<img src="<?= get_template_directory_uri(); ?>/assets/built/images/lp-img1.png" alt="xxx">
					</div>
				</article>
				<article class="feature left-image clearfix">
					<div class="b-left">
						<img src="<?= get_template_directory_uri(); ?>/assets/built/images/lp-img2.png" alt="xxx">
					</div>
					<div class="b-right">
						<h2>The DataRobot Approach</h2>
						<p>DataRobot enables fraud analysts deliver predictive models faster. And it doesn’t require a PhD in data science. DataRobot offers a platform for users of all skill levels to automatically build and deploy accurate predictive models in a fraction of the time it takes with conventional tools and methods. Our powerful machine learning platform enables:</p>
						<ul>
							<li>
								<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/check-mark.png" alt='list'></span>
								Faster and more accurate fraud detection
							</li>
							<li>
								<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/check-mark.png" alt='list'></span>
								Reduced fraud losses and costs of investigation
							</li>
							<li>
								<span><img src="<?= get_template_directory_uri(); ?>/assets/built/images/check-mark.png" alt='list'></span>
		...
		<div class="lp-features-h">
			<div class="container">
				<h2>How Data Robot Delivers Predictive Fraud Models Faster</h2>
				<div class="item-3">
					<img src="<?= get_template_directory_uri(); ?>/assets/built/images/lp-img1.png" alt="xxx">
					<h3>Cutting-Edge Automation</h3>
					<p>DataRobot automates the machine learning process, from data preparation to deployment. Using the best open-source techniques, DataRobot quickly identifies the most accurate models for your data and allows you to start making predictions right away — not weeks or months later.</p>
				</div>
				<div class="item-3">
					<img src="<?= get_template_directory_uri(); ?>/assets/built/images/lp-img1.png" alt="xxx">
					<h3>Streamlined Model Deployment</h3>
					<p>DataRobot offers an easy-to-use web interface for novice and expert users alike. Leverage our built-in model intelligence or use DataRobot’s API to operationalize your own models using R and Python with just a few lines of code. </p>
				</div>
				<div class="item-3">
					<img src="<?= get_template_directory_uri(); ?>/assets/built/images/lp-img1.png" alt="xxx">
					<h3>High-Performance Scalability</h3>
					<p>DataRobot is built for speed and scalability, leveraging the latest methods and open-source tools for fast execution of even the largest and most complex fraud modeling projects. With powerful parallel processing capabilities and multiple deployment options, DataRobot is the fastest path between data and decisions.</p>
				</div>
			</div>
		</div>
		...
		<div class="bottom-form">
			<div class="container">
				<p>With DataRobot, you can rapidly accelerate the time-to-value of fraud models so you can stay ahead of the perpetrators, reduce losses, and minimize time spent dealing with fraud.</p>
				<div class="b-form">
				<div class="dr-form form-blue">
					<!-- <iframe name="hiddenframe" id="hiddenframe" frameborder="0" style="width:0;height:0;border:0;display:none;"></iframe> -->
		        ...
		        <select name="stateProv" id="state" class="select" disabled>
		        	<option value="">State</option>
				        ...
				        <input type="hidden" name="elqSiteID" value="2142644770">
				        <input type="hidden" name="elqCustomerGUID" value="">
						<input type="submit" value="Download now" class="submit bg-filled-button button">
					</form>
