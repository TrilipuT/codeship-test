...
<section class="courses">
	...
	<div class="page-content">
							...
							<div class="item clearfix" id="item_<?php echo $key; ?>">
								<div class="cover">
									...
									<p class="for">Appropriate for <?php the_field('appr_for'); ?></p>
										...
										if($c_classes){ ?>
											<a class="all-classes" href="#upcoming_classes_<?php echo $key; ?>"><i class="icon-circle-right"></i>See upcoming classes</a>
										<?php } ?>
										</div>
									<div class="action-wrap">
									<a href="#" class="contact-popup bg-ghost button" data-source="<?php the_title(); ?>" data-source-url="<?php str_source(get_the_title()); ?>" data-source-id="<?php the_ID(); ?>">Hаve a question?</a>
										</div>
								</div>
									...
									<div class="tab-headers">
										<ul class="clearfix">
											...
											<?php if(get_field('outline_text') || get_field('outline_bullets')){ ?>
												<li><a href="#course_outline_<?php echo $key; ?>" class="transition">Course outline</a></li>
											<?php } ?>
											<?php $c_classes = get_field('class');
												if($c_classes){ ?>
												<li class="classes"><a href="#upcoming_classes_<?php echo $key; ?>" class="transition">Upcoming Classes</a></li>
											<?php } ?>
										</ul>
									</div>
													...
													<ul class="clearfix" id="slider_<?php echo $key; ?>">
														<?php foreach ($c_classes as $c_class) {
															...
															<li>
																...
																<div class="venue"><i class="icon-map-marker"></i><?php echo $c_class['venue']; ?></div>
																<div class="signUp"><a href="<?=$uri;?>" target="_blank" class="<?=$class; ?> bg-filled-green button">Sign up</a></div>
															</li>
														<?php } ?>
													</ul>
													<div class="controls">
		...
		<script type="text/javascript">
			...
			$('.item .contact-popup').click(function(){
				console.log($(this).data("source-id"));
				var progID = $(this).data("source-id");
